...
const Home = ({contract}) => {
    ...
    const loadPosts = async () => {
        ...
        let  posts = await Promise.all(results.map(async i => {
            ...
            let metadataPost = await response.json();
            ...
            {hasProfile ? (
                        ...
                        <div className="content mx-auto">
                            <Row className="g-4">
                                ...
                                <div className="d-grid px-0">
                                    <Button onClick={uploadPost} variant="primary" size="lg">Click To Upload Post</Button>
                                </div>
                            </Row>
                        </div>
                    </main>
                ...
                <div className="text-center">
                    <main style={{ padding: "1rem 0" }}>
                        <h2>Must own an NFT to post, click Profile to mint one NFT</h2>
                    </main>
                </div>
            )}
                        ...
                        <div key={key} className="col-lg-12 my-3 mx-auto" style={{ width: '1000px' }}>
                            <Card border="primary">
                                ...
                                <Card.Footer className="list-group-item">
                                    ...
                                    {address === post.author.address || !hasProfile ? null : <div className="d-inline float-end">
                                        <Button onClick={() => tip(post)} className="px-0 py-0 font-size-16" variant="link" size="md"> Tip for 0.1 ETH</Button>
                                    </div>}
                                </Card.Footer>
                            </Card>
                        </div>
